...
static __always_inline
bool __pmalloc_wr_copy(struct pmalloc_pool *pool, const void *dst,
		       const void *src, size_t n_bytes)
{
...
bool pmalloc_wr_array(struct pmalloc_pool *pool, const void *dst,
		      const void *src, size_t n_bytes)
{
	return __pmalloc_wr_copy(pool, dst, src, n_bytes);
}
...
bool pmalloc_wr_char(struct pmalloc_pool *pool, const char *dst,
		     const char val)
{
	return pmalloc_wr_array(pool, dst, &val, sizeof(val));
}
