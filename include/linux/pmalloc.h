 ...
 */
static __always_inline
bool pmalloc_wr_memset(const void *dst, const int c, size_t n_bytes)
{
	if (WARN(!__check_wr(dst, n_bytes), "Incorrect destination"))
		return false;
 ...
 */
static __always_inline
bool pmalloc_wr_copy(const void *dst, const void *src, size_t n_bytes)
{
	if (WARN(!__check_wr(dst, n_bytes), "Incorrect destination"))
		return false;
 ...
 */
static __always_inline
bool pmalloc_wr_char(const char *dst, const char val)
{
	return pmalloc_wr_copy(dst, &val, sizeof(val));
}
 ...
 */
static __always_inline
bool pmalloc_wr_short(const short *dst, const short val)
{
	return pmalloc_wr_copy(dst, &val, sizeof(val));
}
 ...
 */
static __always_inline
bool pmalloc_wr_ushort(const unsigned short *dst, const unsigned short val)
{
	return pmalloc_wr_copy(dst, &val, sizeof(val));
}
 ...
 * Return: true upon success, false otherwise
 */
static __always_inline bool pmalloc_wr_int(const void *dst, const int val)
{
	return pmalloc_wr_copy(dst, &val, sizeof(val));
}
 ...
 */
static __always_inline
bool pmalloc_wr_uint(const void *dst, const unsigned int val)
{
	return pmalloc_wr_copy(dst, &val, sizeof(val));
}
 ...
 */
static __always_inline
bool pmalloc_wr_long(const void *dst, const long val)
{
	return pmalloc_wr_copy(dst, &val, sizeof(val));
}
 ...
 */
static __always_inline
bool pmalloc_wr_ulong(const void *dst, const unsigned long val)
{
	return pmalloc_wr_copy(dst, &val, sizeof(val));
}
 ...
 */
static __always_inline
bool pmalloc_wr_longlong(const void *dst, const long long val)
{
	return pmalloc_wr_copy(dst, &val, sizeof(val));
}
 ...
 */
static __always_inline
bool pmalloc_wr_ulonglong(const unsigned long long *dst,
 ...
 */
static __always_inline
bool pmalloc_wr_ptr(const void *dst, const void *val)
{
	return pmalloc_wr_copy(dst, &val, sizeof(val));
}
