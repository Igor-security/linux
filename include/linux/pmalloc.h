...
/*
 * Pmalloc API
 * The part providing rare-write functionality is fully implemented as
 * __always_inline, to prevent having an internal function call that is
 * capable of modifying write protected memory.
